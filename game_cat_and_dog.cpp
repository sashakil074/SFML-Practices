...
//	srand(time(NULL));
//
//	sf::RenderWindow window(VideoMode(1280, 720), "Cat do(d)ge");
...
//	Sprite cat;
//
//	if (!catTex.loadFromFile("Textures/cat.jfif"))
//		throw "Could not load cat.png!";
//
//	cat.setTexture(catTex);
//	cat.setScale(Vector2f(0.2f, 0.3f));
...
//	doge.setScale(Vector2f(0.3f, 0.2f));
//
//	//GAME LOOP
